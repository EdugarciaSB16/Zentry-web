            ...
            <div className="container mx-auto px-3 md:px-10">
                <div className="px-5 py-32">
                    ...
                    <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
                        Immese yourself in a rich and ever-expanding universe
                        where a vibrant array of products coverge into an
                        interconnected overlay experience on your world.
                    </p>
                </div>

                <BentTilt className="border-hsla relative mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65vh]">
                    <BentoCard
